...
item_2 = 3
# Создать переменную result_sum в которой вы суммируете item_1 и item_2
result_sum = item_1 + item_2
# Вывести result_sum в консоль
print(result_sum)
# Создать переменную result_subtr в которой вы вычитаете большую по значению переменную из меньшей по значению
result_subtr = item_2 - item_1
# Вывести result_subtr в консоль
print(result_subtr)
# Создать переменную result_multi в которой вы умножаете item_1 на item_2
result_multi = item_1 * item_2
# Вывести result_multi в консоль
print(result_multi)
# Создать переменную result_exp в которой вы item_1 возводите в степень item_2
result_exp = item_1 ** item_2
# Вывести result_exp в консоль
print(result_exp)
import math
# Создать переменную result_m_exp в которой вы item_1 возводите в степень item_2
# используя библиотеку math
result_m_exp = math.pow(item_1, item_2)
# Вывести result_m_exp в консоль
print(result_m_exp)
#Создать переменную result_s_root в которой вы найдёте квадратный корень любой
#из переменной item
result_s_root = item_1 ** 0.5
# Вывести result_s_root в консоль
print(result_s_root)
# Создать переменную result_m_s_root в которой вы найдёте квадратный корень
# любой из переменной item используя библиотеку math
result_s_root  = math.sqrt(item_1)
# Вывести result_m_s_root в консоль
print(result_s_root)
# Создать переменную result_mp_s_root в которой вы найдёте квадратный корень любой из переменной item
# используя библиотеку math используя метод pow
result_mp_s_root = math.pow(item_2, 2)
# Вывести result_mp_s_root в консоль
print(result_mp_s_root)
# Присвоить переменной item_1 odd значение
item_1 = 13
# Присвоить переменной item_2 even значение
item_2 = 8
# Создать переменную result_division в которой вы разделите item_1 на item_2
result_division = item_1 / item_2
# Вывести result_division в консоль
print(result_division)
# Создать переменную result_m_floor и result_division округлить до ближайшего
# целого меньшего чем result_division
result_m_floor = math.floor(1.625)
# Вывести result_m_floor в консоль
print(result_m_floor)
# Создать переменную result_m_ceil и result_division округлить до ближайшего целого
# большего чем result_division
result_m_ceil = math.ceil(1.625)
# Вывести result_m_ceil в консоль
print(result_m_ceil)
# Создать переменную result_int и result_division округлить до ближайшего целого
# через явное приведение
result_int = int(5.7)
result_devision = int(5.2)
# Вывести result_int в консоль
print(result_int)
print(result_devision)
# Создать переменную result_no_division_loss в которой вы разделите item_1 на
# item_2 без остатка
result_no_devision_loss = item_1 // item_2
# Вывести result_no_division_loss в консоль
print(result_no_devision_loss)
# Создать переменную result_division_loss в которой вы найдёте остаток от деления
# item_1 на item_2
result_no_devision_loss = item_1 % item_2
# Вывести result_division_loss в консоль
print(result_no_devision_loss)
# Создать переменную item_3 и присвоить ей целое число
item_3 = 10
...
# Вывести item_3 в консоль
print(item_3)
# Найти квадратный корень item_3 с присвоением
item_3 **= .5
# Вывести item_3 в консоль
print(item_3)
...
b_item_1_int = int(2.2)
# Вывести b_item_1_int в консоль
print(b_item_1_int)
# Создать переменную b_item_2_int и присвоить явное
#  b_item_2 к int
b_item_2_int = int(3.6)
